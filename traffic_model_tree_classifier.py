...
########   Summary of  model using Classification Tree   ####

## Accuracy of  Classification Tree  classifier on test set: 0.99
...
##         2.0       0.97      0.98      0.98      1511
##         3.0       0.98      0.97      0.98      1472
...
# Save the figure
fig.show()
fig.savefig('fig1_test2.png', bbox_inches='tight')
...
###Fitting Classification Tree  on the data ####
...
print('Accuracy of Classification Tree classifier on test set: {:.2f}'.format(dtree.score(X_test, y_test)))

confusion_matrix = confusion_matrix(y_test, y_pred_tree)
#print(confusion_matrix)
print (pd.crosstab(y_test,y_pred_tree))
